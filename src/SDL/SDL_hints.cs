...
/// </summary>
/// <remarks>
/// Refer to the official <see href="https://wiki.libsdl.org/SDL3/SDL_HintPriority">documentation</see> for more details.
/// </remarks>
...
{
	/// <summary>
	/// A collection of hints used across SDL.
	/// </summary>
	public static class Hint
	{
		...
		/// <summary>
		/// A variable containing a list of devices to ignore in <see cref="hid_enumerate(ushort, ushort)"/>.
		/// </summary>
		/// <remarks>
