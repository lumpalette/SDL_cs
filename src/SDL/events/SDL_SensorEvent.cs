...
{
	/// <summary>
	/// Returns <see cref="SDL_EventType.SensorUpdate"/>.
	/// </summary>
	...
	/// <summary>
	/// Up to 6 values from the sensor - additional values can be queried using <see cref="SDL.GetSensorData(SDL_Sensor*, ref float[])"/>.
	/// </summary>
