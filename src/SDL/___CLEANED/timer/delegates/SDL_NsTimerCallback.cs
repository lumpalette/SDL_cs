...
/// </remarks>
/// <param name="userData"> Sn arbitrary pointer provided by the app through <see cref="SDL.AddTimerNs(ulong, SDL_NsTimerCallback, nint)"/>, for its own use. </param>
...
public unsafe delegate ulong SDL_NsTimerCallback(nint userData, SDL_TimerId timerId, ulong intervalNs);