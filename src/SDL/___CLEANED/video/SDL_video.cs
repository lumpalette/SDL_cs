...
public static unsafe partial class SDL
{
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetVideoDriver", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetCurrentVideoDriver", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetDisplayName", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetWindowTitle", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	/// </remarks>
	/// <param name="window">The window to query.</param>
	/// <returns>The mouse confinement rectangle of a window, or <see langword="null"/> if there isn't one.</returns>
	public static SDL_Rect? GetWindowMouseRect(SDL_Window* window)
	{
		SDL_Rect* rect = SDL_GetWindowMouseRect(window);
		if (rect is not null)
		{
			return *rect;
		}
		...
		static extern SDL_Rect* SDL_GetWindowMouseRect(SDL_Window* window);
	}
