...
public static unsafe partial class SDL
{
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetAudioDriver", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetAudioDeviceName", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
