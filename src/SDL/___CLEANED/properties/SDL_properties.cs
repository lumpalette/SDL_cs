...
unsafe partial class SDL
{
	...
	/// <param name="value">The new value of the property, or <see cref="nint.Zero"/> to delete the property.</param>
	/// <returns>0 on success or a negative error code on failure; call <see cref="GetError"/> for more information.</returns>
	[LibraryImport(LibraryName, EntryPoint = "SDL_SetProperty", StringMarshalling = StringMarshalling.Utf8)]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial int SetProperty(SDL_PropertiesId props, string name, nint value);
