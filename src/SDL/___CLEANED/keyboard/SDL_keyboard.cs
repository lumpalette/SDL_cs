...
public static unsafe partial class SDL
{
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetKeyboardNameForID", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetScancodeName", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	...
	[LibraryImport(LibraryName, EntryPoint = "SDL_GetKeyName", StringMarshallingCustomType = typeof(SDLManagedString))]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
