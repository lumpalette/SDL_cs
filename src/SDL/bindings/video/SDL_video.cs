...
public static unsafe partial class SDL
{
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetVideoDriverTemp(int index);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetCurrentVideoDriverTemp();
	...
	public static SDL_DisplayId[]? GetDisplays(out int count)
	{
		...
		SDL_DisplayId* displaysPtr = GetDisplaysTemp(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_DisplayId* GetDisplaysTemp(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetDisplayNameTemp(SDL_DisplayId instanceId);
	...
	public static SDL_DisplayMode*[]? GetFullscreenDisplayModes(SDL_DisplayId instanceId, out int count)
	{
		...
		SDL_DisplayMode** modesPtr = GetFullscreenDisplayModesTemp(instanceId, out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_DisplayMode** GetFullscreenDisplayModesTemp(SDL_DisplayId instanceId, out int count);
	...
	public static SDL_Window*[]? GetWindows(out int count)
	{
		...
		SDL_Window** windowsPtr = GetWindowsTemp(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_Window** GetWindowsTemp(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetWindowTitleTemp(SDL_Window* window);
