...
public static unsafe partial class SDL
{
	...
	public static SDL_JoystickId[]? GetJoystick(out int count)
	{
		...
		SDL_JoystickId* joysticksPtr = GetJoysticks_Raw(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_JoystickId* GetJoysticks_Raw(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetJoystickNameForId_Raw(SDL_JoystickId instanceId);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetJoystickPathForId_Raw(SDL_JoystickId instanceId);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetJoystickName_Raw(SDL_Joystick* joystick);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetJoystickPath_Raw(SDL_Joystick* joystick);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetJoystickSerial_Raw(SDL_Joystick* joystick);
