...
public static unsafe partial class SDL
{
	...
	public static SDL_MouseId[]? GetMice(out int count)
	{
		...
		SDL_MouseId* micePtr = GetMice_Raw(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_MouseId* GetMice_Raw(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetMouseNameForId_Raw(SDL_MouseId instanceId);
