...
public static unsafe partial class SDL
{
	...
	public static SDL_MouseId[]? GetMice(out int count)
	{
		...
		SDL_MouseId* micePtr = GetMiceTemp(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_MouseId* GetMiceTemp(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetMouseNameForIdTemp(SDL_MouseId instanceId);
