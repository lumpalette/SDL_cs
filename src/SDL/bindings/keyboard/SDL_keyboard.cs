...
public static unsafe partial class SDL
{
	...
	public static SDL_KeyboardId[]? GetKeyboards(out int count)
	{
		...
		SDL_KeyboardId* keyboardsPtr = GetKeyboardsTemp(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_KeyboardId* GetKeyboardsTemp(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetKeyboardNameForIdTemp(SDL_KeyboardId instanceId);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetScancodeNameTemp(SDL_Scancode scancode);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetKeyNameTemp(SDL_Keycode key);
