...
public static unsafe partial class SDL
{
	...
	public static SDL_KeyboardId[]? GetKeyboards(out int count)
	{
		...
		SDL_KeyboardId* keyboardsPtr = GetKeyboards_Raw(out count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDL_KeyboardId* GetKeyboards_Raw(out int count);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetKeyboardNameForId_Raw(SDL_KeyboardId instanceId);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetScancodeName_Raw(SDL_Scancode scancode);
	...
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial byte* GetKeyName_Raw(SDL_Keycode key);
