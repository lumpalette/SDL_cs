...
unsafe partial class SDL
{
	...
	/// <see href="https://wiki.libsdl.org/SDL3/SDL_PointInRect">documentation</see> for more details.
	/// </remarks>
	...
	/// <remarks>
	/// This is not inlined, as C# does not support inline functions. Refer to the official documentation
	/// <see href="https://wiki.libsdl.org/SDL3/SDL_RectEmpty">documentation</see> for more details.
	/// </remarks>
	/// <param name="r"> The rectangle to test. </param>
