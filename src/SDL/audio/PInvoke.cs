...
unsafe partial class SDL
{
	...
	public static SDL_AudioDeviceId[]? GetAudioPlaybackDevices(out int count)
	{
		fixed (int* c = &count)
		{
			SDL_AudioDeviceId* d = _PInvoke(c);
			if (d is null)
			{
				return null;
			}
	...
	{
		fixed (SDL_AudioSpec* s = &spec)
		{
			fixed (int* p = &sampleFrames)
			{
				return _PInvoke(deviceId, s, p);
			}
		}
	...
	/// </remarks>
	/// <param name="deviceId"> The device instance id to open, or <see cref="AudioDeviceDefaultPlayback"/> or <see cref="AudioDeviceDefaultRecording"/> for the most reasonable default device. </param>
	...
	public static SDL_AudioDeviceId OpenAudioDevice(SDL_AudioDeviceId deviceId, ref SDL_AudioSpec? spec)
	{
		if (spec.HasValue)
		{
			SDL_AudioSpec s = spec.Value;
			return _PInvoke(deviceId, &s);
		}
		return _PInvoke(deviceId, null);
	...
	/// </remarks>
	/// <param name="deviceId"> A device opened by <see cref="OpenAudioDevice(SDL_AudioDeviceId, SDL_AudioSpec?)"/>. </param>
	/// <returns> 0 on success or a negative error code on failure; call <see cref="GetError"/> for more information. </returns>
	...
	{
		fixed (SDL_AudioStream** s = streams)
		{
			return _PInvoke(deviceId, s, streams.Length);
		}
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_BindAudioStream">here</see>.
	/// </remarks>
	/// <param name="deviceId"> An audio device to bind a stream to. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_UnbindAudioStreams">here</see>.
	/// </remarks>
	/// <param name="streams"> An array of audio streams to unbind. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_UnbindAudioStream">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamDevice">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_CreateAudioStream">here</see>.
	/// </remarks>
	...
	{
		fixed (SDL_AudioSpec* s = &srcSpec, d = &dstSpec)
		{
			return _PInvoke(s, d);
		}
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamProperties">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamFormat">here</see>.
	/// </remarks>
	/// <param name="stream"> The <see cref="SDL_AudioStream"/> to query. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_SetAudioStreamFormat">here</see>.
	/// </remarks>
	...
	public static int SetAudioStreamFormat(SDL_AudioStream* stream, ref SDL_AudioSpec? srcSpec, ref SDL_AudioSpec? dstSpec)
	{
		...
		if (srcSpec.HasValue)
		{
			SDL_AudioSpec value = srcSpec.Value;
			s = &value;
		}
		SDL_AudioSpec* d = null;
		if (srcSpec.HasValue)
		{
			SDL_AudioSpec value = srcSpec.Value;
			d = &value;
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamFrequencyRatio">here</see>.
	/// </remarks>
	/// <param name="stream"> The <see cref="SDL_AudioStream"/> to query. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_SetAudioStreamFrequencyRatio">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_PutAudioStreamData">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamData">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamAvailable">here</see>.
	/// </remarks>
	/// <param name="stream"> The audio stream to query. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetAudioStreamQueued">here</see>.
	/// </remarks>
	/// <param name="stream"> The audio stream to query. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_FlushAudioStream">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_ClearAudioStream">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_PauseAudioStreamDevice">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_ResumeAudioStreamDevice">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_LockAudioStream">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_UnlockAudioStream">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_SetAudioStreamGetCallback">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_SetAudioStreamPutCallback">here</see>.
	/// </remarks>
	/// <param name="stream"> The audio stream to set the new callback on. </param>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_DestroyAudioStream">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_OpenAudioDeviceStream">here</see>.
	/// </remarks>
	/// <param name="deviceId"> An audio device to open, or <see cref="AudioDeviceDefaultPlayback"/> or <see cref="AudioDeviceDefaultRecording"/> </param>
	...
	public static SDL_AudioStream* OpenAudioDeviceStream(SDL_AudioDeviceId deviceId, ref SDL_AudioSpec? spec, SDL_AudioStreamCallback callback, void* userData)
	{
		if (spec.HasValue)
		{
			SDL_AudioSpec s = spec.Value;
			return _PInvoke(deviceId, &s, callback, userData);
		}
		return _PInvoke(deviceId, null, callback, userData);
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_SetAudioPostmixCallback">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_LoadWAV">here</see>.
	/// </remarks>
	...
	public static int LoadWav(string path, out SDL_AudioSpec spec, out byte* audioBuffer, out uint audioLength)
	{
		...
		fixed (byte* p = Encoding.UTF8.GetBytes(path))
		{
			...
			{
				// w
				fixed (byte** b = &audioBuffer)
				{
					// e
					fixed (uint* l = &audioLength)
					{
						return _PInvoke(p, s, b, l);
					}
				}
			}
		}
	...
	/// documentation <see href="https://wiki.libsdl.org/SDL3/SDL_MixAudio">here</see>.
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_ConvertAudioSamples">here</see>.
	/// </remarks>
	/// <param name="srcSpec"> The format details of the input audio. </param>
	...
	public static int ConvertAudioSamples(ref SDL_AudioSpec srcSpec, byte* srcData, int srcLength, ref SDL_AudioSpec dstSpec, out byte* dstData, out int dstLength)
	{
		...
		{
			fixed (int* l = &dstLength)
			{
				fixed (SDL_AudioSpec* s = &srcSpec, d = &dstSpec)
				{
					return _PInvoke(s, srcData, srcLength, d, dst, l);
				}
			}
		}
	...
	/// </summary>
	/// <remarks>
	/// Refer to the official documentation <see href="https://wiki.libsdl.org/SDL3/SDL_GetSilenceValueForFormat">here</see>.
	/// </remarks>
